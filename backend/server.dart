...
import 'src/controllers/bills.dart';
import 'src/controllers/photos.dart';
...
void main() async {
  ...
  app.mount('/api/hangouts', HangoutController().router);
  app.mount('/api/bills',    BillsController().router);
  app.mount('/api/photos',   PhotosController().router);
